...
#   source ./scripts/set_cauvid_data_root.sh /storage-02/ml-jsha
#   source ./scripts/set_cauvid_data_root.sh DATA_ROOT OUTPUT_ROOT
#
# Notes:
...
Examples:
  source ./scripts/set_cauvid_data_root.sh /storage-01/ml-jsha/CauVid_Data
  source ./scripts/set_cauvid_data_root.sh /storage-02/ml-jsha
  source ./scripts/set_cauvid_data_root.sh /storage-01/ml-jsha/CauVid_Data /storage-01/ml-jsha/CauVid_output
EOF
}
...
export CAUVID_OUTPUT_JULY_HOST="$CAUVID_OUTPUT_ROOT/pipeline_july"
...
echo "  CAUVID_OUTPUT_JULY_HOST=$CAUVID_OUTPUT_JULY_HOST"
