...
DEFAULT_RAW_ROOT = Path("/home/ml-jsha/storage/CauVid_Data/driving-video-with-object-tracking")
...
def extract_video_frames(
    ...
    import cv2
    from src.exp_driving_videos.data_preprocessing import get_video_rotation, rotate_frame
...
def generate_depth_for_videos(
    ...
    from src.exp_driving_videos.data_preprocessing import generate_frame_depth_maps
