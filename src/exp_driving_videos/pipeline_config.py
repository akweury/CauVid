...
DRIVING_MINI_OD_MODEL = "weights/yolo/yolov8l-worldv2.pt"
DEFAULT_TRAIN_VIDEO_COUNT = 942
DEFAULT_EVAL_VIDEO_COUNT = 19
    ...
    return _load_cfg_section(
        {
            ...
            "max_rounds": 5,
            "removal_mode": "strict",
            "max_remove_fraction_per_round": 0.2,
            "selection_metric": "f1",
            "tie_breaker": "precision",
            "early_stop_no_improvement_rounds": 2,
            ...
            "max_descendant_replacements_per_round": 3,
            "max_descendant_rounds": 6,
    ...
    return _load_cfg_section(
        {
            ...
            "rule_aggregation_baseline": False,
            "baseline_safe_calibration_gate": False,
            "object_to_atom_coverage_diagnostic": False,
            "traffic_control_rule_utility_diagnostic": False,
            "traffic_control_temporal_alignment_diagnostic": False,
            "traffic_light_detection_quality_audit": False,
            ...
            "rule_selection_visualization": False,
            "integrated_method_visualization": False,
            "background_causal_prior": False,
            "reasoning_feedback_signal": False,
        },
