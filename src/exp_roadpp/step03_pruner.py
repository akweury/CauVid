...
class Pruner:
    ...
    def coarse_prune(self, init_clauses):
        ...
        pruned_init_clauses = {key: value for key, value in pruned_init_clauses.items() if support_per_clause[key] / coverage_per_clause[key] >= self.support_coverage_ratio_th}
