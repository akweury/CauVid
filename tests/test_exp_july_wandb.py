...
_PERCEPTION_EXPORTS = (
    ...
    "step7b_background_motion_evidence",
    "step7c_video_local_evidence_calibration",
    "step7d_global_symbolic_rule_evaluation",
    ...
    "step8h_trajectory_repair_visualization",
    "step8i_trajectory_audit_dashboard",
    "step8j_trajectory_provenance_audit",
